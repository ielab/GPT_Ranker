...
|                       |Top 500 |         |           |
|                       |Top 1000|         |           |
|BM25 Initial Retrieval |  N/A   | `recall_5 all 0.4024`<br/>`recall_10 all 0.4946`<br/>`recall_15 all 0.5640`<br/>`recall_20 all 0.6095`<br/>`recall_30 all 0.6649`<br/>`recall_100 all 0.7874`<br/>`recall_200 all 0.8373`<br/>`recall_500 all 0.8850`<br/>`recall_1000 all 0.9187` | `0.27880910` |
...
|                       |Top 1000 Lower| `recall_5 all 0.4546`<br/>`recall_10 all 0.5733`<br/>`recall_15 all 0.6346`<br/>`recall_20 all 0.6679`<br/>`recall_30 all 0.7133`<br/>`recall_100 all 0.8095`<br/>`recall_200 all 0.8384`<br/>`recall_500 all 0.8552`<br/>`recall_1000 all 0.8573` | `0.2945217`  |
| GPT-2                 |Top 100       |         |          |
|                       |Top 200       |         |          |
|                       |Top 500       |         |          |
|                       |Top 1000      |         |          |
