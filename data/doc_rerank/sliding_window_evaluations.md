# 1. no title only sliding window:
...
```
### 1.1.3 top2000 window, cutoff0 doc and using max aggregation:
```
recall_5                all     0.3588
recall_10               all     0.4708
recall_15               all     0.5319
...
recall_1000             all     0.9114
```
### 1.1.4 top2000 window, cutoff0 doc and using sum aggregation:
```
recall_5                all     0.1067
recall_10               all     0.1664
recall_15               all     0.2209
...
recall_1000             all     0.9062
```
### 1.2.3 top2000 window, cutoff0 doc and using max aggregation:
```
recall_5                all     0.3717
recall_10               all     0.4845
recall_15               all     0.5357
...
recall_1000             all     0.9062
```
### 1.2.4 top2000 window, cutoff0 doc and using sum aggregation:
```
recall_5                all     0.1223
recall_10               all     0.1958
recall_15               all     0.2459
...
recall_1000             all     0.9062
```
### 1.3.3 top2000 window, cutoff0 doc and using max aggregation:
```
recall_5                all     0.3747
recall_10               all     0.4864
recall_15               all     0.5419
...
recall_1000             all     0.9062
```
### 1.3.4 top2000 window, cutoff0 doc and using sum aggregation:
```
recall_5                all     0.1204
recall_10               all     0.1933
recall_15               all     0.2459
...
```
### 2.1.3 top2000 window, cutoff0 doc and using max aggregation:
```
recall_5                all     0.3210
recall_10               all     0.4285
recall_15               all     0.4872
...
recall_1000             all     0.8910
```
### 2.1.4 top2000 window, cutoff0 doc and using sum aggregation:
```
recall_5                all     0.0919
recall_10               all     0.1454
recall_15               all     0.1953
...
```
### 2.2.3 top2000 window, cutoff0 doc and using max aggregation:
```
recall_5                all     0.3445
recall_10               all     0.4485
recall_15               all     0.5016
...
recall_1000             all     0.8868
```
### 2.2.4 top2000 window, cutoff0 doc and using sum aggregation:
```
recall_5                all     0.1096
recall_10               all     0.1741
recall_15               all     0.2222
...
```
### 2.3.3 top2000 window, cutoff0 doc and using max aggregation:
```
recall_5                all     0.3449
recall_10               all     0.4500
recall_15               all     0.5059
...
recall_1000             all     0.8877
```
### 2.3.4 top2000 window, cutoff0 doc and using sum aggregation:
```
recall_5                all     0.1071
recall_10               all     0.1706
recall_15               all     0.2195
